...
async function main() {
  const sqlFile = path.resolve(__dirname, "../supabase/subscription_usage_migration.sql");
  ...
  if (error) {
    ...
    console.log("\n⚠️  Please copy the contents of supabase/subscription_usage_migration.sql and run them manually in your Supabase Dashboard -> SQL Editor!");
  } else {
