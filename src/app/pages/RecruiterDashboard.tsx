...
function PostJobPage() {
  ...
  const handleSubmit = async (e?: React.FormEvent) => {
    ...
    try {
      ...
      setFormData({ jobTitle:"",jobDescription:"",rolesResponsibilities:"",requirements:"",location:"",workMode:"",salaryMin:"",salaryMax:"",experienceMin:"",experienceMax:"",skills:"",employmentType:"",industry:"",openings:"1",education:"",perks:[],department:"",interviewMode:"",applicationDeadline:"",applicationDeadlineTime:"" });
      setShowSkillInput(false);
      setSkillPickerOpen(false);
      setSkillSearch("");
    } catch (err: unknown) {
...
function ManageJobsPage() {
  ...
  const [editForm, setEditForm] = useState({ title: "", location: "", salaryMin: "", salaryMax: "", employmentType: "", workMode: "", openings: "1", skills: "", deadlineDate: "", deadlineTime: "" });
